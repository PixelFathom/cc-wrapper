...
import {
  ...
  FileTextIcon, CodeIcon, ChevronDownIcon,
  UpdateIcon, InfoCircledIcon, ClockIcon, ExclamationTriangleIcon
...
export function ApprovalModal({ approval, onClose }: ApprovalModalProps) {
  ...
  const getUrgencyLevel = () => {
    if (approval.action_type === 'command') return 'high'
    if (['file_write', 'file_edit'].includes(approval.action_type)) return 'medium'
    return 'low'
  }
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              <p className="text-gray-200 leading-relaxed">
                {approval.prompt || approval.details?.reason || 'This action requires your approval to proceed.'}
              </p>
            </div>
